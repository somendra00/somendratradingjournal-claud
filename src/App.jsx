...
const rawTrades = [
  { ticker: "BTC/USD", cls: "Crypto", dir: "Long", entry: 61250, exit: 64380, size: 0.42, rr: 2.4, date: "2026-06-14T09:12:00", setup: "Breakout", notes: "Clean range breakout, held through pullback", pnl: 1314 },
  { ticker: "ETH/USD", cls: "Crypto", dir: "Long", entry: 3180, exit: 3065, size: 3.1, rr: 1.5, date: "2026-06-16T14:40:00", setup: "Mean Reversion", notes: "Faded too early, invalidated support", pnl: -356 },
  { ticker: "AAPL", cls: "Equity", dir: "Long", entry: 189.4, exit: 196.1, size: 60, rr: 2.0, date: "2026-06-18T10:05:00", setup: "Breakout", notes: "Earnings drift continuation", pnl: 402 },
  { ticker: "TSLA", cls: "Equity", dir: "Short", entry: 244.8, exit: 231.2, size: 25, rr: 2.8, date: "2026-06-19T15:22:00", setup: "Reversal", notes: "Double top on the 1H, textbook", pnl: 340 },
  { ticker: "EUR/USD", cls: "Forex", dir: "Long", entry: 1.0812, exit: 1.0779, size: 100000, rr: 1.2, date: "2026-06-21T08:00:00", setup: "Mean Reversion", notes: "News spike caught the stop", pnl: -330 },
  { ticker: "NAS100", cls: "Index", dir: "Long", entry: 19340, exit: 19610, size: 2, rr: 2.2, date: "2026-06-23T13:15:00", setup: "Trend Continuation", notes: "Rode the opening drive", pnl: 540 },
  { ticker: "SOL/USD", cls: "Crypto", dir: "Long", entry: 142.5, exit: 156.8, size: 18, rr: 3.1, date: "2026-06-25T11:48:00", setup: "Breakout", notes: "Waited for retest, textbook entry", pnl: 257 },
  { ticker: "GBP/USD", cls: "Forex", dir: "Short", entry: 1.2680, exit: 1.2711, size: 80000, rr: 1.4, date: "2026-06-27T07:30:00", setup: "Reversal", notes: "Chased the move, no confirmation", pnl: -248 },
  { ticker: "MSFT", cls: "Equity", dir: "Long", entry: 421.2, exit: 431.9, size: 22, rr: 2.1, date: "2026-06-29T16:02:00", setup: "Trend Continuation", notes: "Held through earnings, size was right", pnl: 235 },
  { ticker: "BTC/USD", cls: "Crypto", dir: "Short", entry: 66200, exit: 63410, size: 0.35, rr: 2.6, date: "2026-07-01T09:50:00", setup: "Reversal", notes: "Liquidity sweep then rejection", pnl: 977 },
  { ticker: "US30", cls: "Index", dir: "Short", entry: 39510, exit: 39180, size: 1.5, rr: 1.9, date: "2026-07-02T14:10:00", setup: "Mean Reversion", notes: "Faded the overextension into resistance", pnl: 495 },
  { ticker: "NVDA", cls: "Equity", dir: "Long", entry: 128.4, exit: 121.9, size: 40, rr: 1.6, date: "2026-07-03T15:45:00", setup: "Breakout", notes: "False breakout, cut it fast", pnl: -260 },
  { ticker: "ETH/USD", cls: "Crypto", dir: "Long", entry: 3320, exit: 3510, size: 2.8, rr: 2.3, date: "2026-07-05T10:20:00", setup: "Trend Continuation", notes: "Scaled out at two targets", pnl: 532 },
  { ticker: "USD/JPY", cls: "Forex", dir: "Long", entry: 156.20, exit: 157.85, size: 90000, rr: 2.0, date: "2026-07-07T08:55:00", setup: "Breakout", notes: "Session open momentum, clean", pnl: 950 },
  { ticker: "AMZN", cls: "Equity", dir: "Long", entry: 186.7, exit: 191.4, size: 35, rr: 1.8, date: "2026-07-08T13:30:00", setup: "Mean Reversion", notes: "Bounced off the daily VWAP", pnl: 165 },
  { ticker: "SOL/USD", cls: "Crypto", dir: "Short", entry: 168.2, exit: 172.6, size: 15, rr: 1.3, date: "2026-07-09T12:05:00", setup: "Reversal", notes: "Wrong side of momentum, exited on plan", pnl: -66 },
  { ticker: "NAS100", cls: "Index", dir: "Long", entry: 19880, exit: 20240, size: 1.8, rr: 2.5, date: "2026-07-10T09:40:00", setup: "Breakout", notes: "Gap and go, best trade of the week", pnl: 648 },
  { ticker: "BTC/USD", cls: "Crypto", dir: "Long", entry: 65100, exit: null, size: 0.28, rr: 2.4, date: "2026-07-12T07:15:00", setup: "Trend Continuation", notes: "Still running, trailing stop active", pnl: null, status: "Open" },
];

function buildTrades() {
  return rawTrades.map((t, i) => {
    const status = t.status ? t.status : t.pnl > 0 ? "Win" : t.pnl < 0 ? "Loss" : "Break-even";
    const roi =
      t.pnl !== null && t.entry
        ? (t.pnl / (t.entry * (t.cls === "Forex" ? t.size / 10000 : t.size))) * 100
        : null;
    return { id: i + 1, ...t, status, roi };
  });
}

const initialTrades = buildTrades();
...
export default function App() {
  ...
  const [log, setLog] = useState(initialTrades);
