...
/* ---------------------------------------------------------------
   TOKENS — Aurora Dark palette
   bg        #0A0F1C  (background)
   surface   #121826  (surface 1)
   surface-2 #1A2233  (surface 2)
   line      rgba(148,163,184,0.14)
   ink       #E2E8F0  (text primary)
   ink-dim   #94A3B8  (text secondary)
   violet    #22D3EE  (primary — used as the app's main accent)
   secondary #00E5A8
   accent    #A78BFA  (paired with primary in gradient CTAs)
   lime      #10B981  (success / profit)
   coral     #F43F5E  (danger / loss)
   amber     #F59E0B  (warning / open)
...
const COLORS = {
  ...
  inkFaint: "#5B6B85",
  violet: "#22D3EE",
  violetSoft: "rgba(34,211,238,0.12)",
  lime: "#10B981",
...
const GRADIENT_PRIMARY = "linear-gradient(90deg, #22D3EE 0%, #A78BFA 100%)";
      ...
      <div className="rounded-2xl p-6" style={{ background: "var(--glass-card-bg)", border: "1px solid var(--glass-card-border)", backdropFilter: "var(--glass-card-blur)", WebkitBackdropFilter: "var(--glass-card-blur)" }}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          <button
            ...
            className="text-left p-4 rounded-xl transition-colors hover:bg-white/[0.03]"
            style={{ background: COLORS.violetSoft, border: `1px solid rgba(34,211,238,0.35)` }}
          >
